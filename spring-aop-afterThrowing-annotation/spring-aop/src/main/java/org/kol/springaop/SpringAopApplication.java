...
public class SpringAopApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("------------@AfterReturning @AfterThrowing Example-----------");
     ...
     // always eligibleTransaction() should run After accountOpen()
		...
		employee.doException();

		System.out.println("-------------------------------------------------");

		/* output::
------------@AfterReturning & @AfterThrowing Example-----------
------------:Employee Area:-----------
Employee-AMOUNT: Eligible
afterReturning():5000
Normal Method Call Return Value: 5000
afterThrowing() throw exception is:org.kol.springaop.exception.CustomException: HI! I'M CUSTOM EXCEPTION
-->exception msg
		 */
