...
import org.kol.springaop.exception.CustomException;
...
public class Human {
    ...
    @AfterThrowing(pointcut=("execution( public * doException()))"), throwing = "returnEx")
    // Always eligibleTransaction() should run After accountOpen()
    public void eligibleBalance(CustomException returnEx){

        System.out.println("afterThrowing() throw exception is:"+returnEx);
    }
